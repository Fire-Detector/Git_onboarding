...
public class Frame_Disk extends javax.swing.JFrame {
    ...
    private void loadDeskData() {
        ArrayList<Desk_02> deskList = Desk_02.getDeskList();

        String[] columnNames = { "상품 ID", "디스크 ID", "디스크 정보", "가격" };
        Object[][] data = new Object[deskList.size()][4];

        for (int i = 0; i < deskList.size(); i++) {
            Desk_02 desk = deskList.get(i);
            data[i][0] = desk.getProdctid();
            data[i][1] = desk.getDeskid();
            data[i][2] = desk.getDiskdata();
            data[i][3] = desk.getPrice();
        }
