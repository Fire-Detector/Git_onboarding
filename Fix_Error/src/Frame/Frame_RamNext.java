 ...
 * @author 솔데스크
 */
public class Frame_RamNext extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frame_RamNext.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
